<div class="tab-pane fade" id="akun-puskesmas-tab-pane" role="tabpanel" aria-labelledby="akun-puskesmas-tab" tabindex="0">
            ...
            <tbody>
                @foreach ($users as $user)
                    <tr id="user_{{ $user->id }}">
                        ...
                        <td>{{ $user->email }}</td>
                        <td>
                            <form action="{{ route('user_puskesmas.toggle-active', $user->id) }}" method="POST"
                                class="d-inline">
                                @csrf
                                @method('POST')
                        ...
                        <td>
                            {{ $user->puskesmas->first() ? $user->puskesmas->first()->nama_puskesmas : 'N/A' }}
                        </td>
                        <td>
                            ...
                            <form action="{{ route('user_puskesmas.destroy', $user->id) }}" method="POST"
                                class="d-inline">
                                @csrf
                                @method('delete')
                    ...
                    @include('puskesmas.akun_puskesmas.edit', ['data' => $user, 'puskesmas' => $puskesmas])
                @endforeach
            </tbody>
        </table>
    </div>
