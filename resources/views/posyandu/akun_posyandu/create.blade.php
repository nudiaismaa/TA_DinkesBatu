    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tambah Akun Posyandu</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="{{ route('user_posyandu.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row gap-3">
                        <div class="col-12">
                            <label for="posyandu_id" class="form-label">Posyandu</label>
                            <select class="form-select" name="posyandu_id" id="posyandu_id">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" id="name" class="form-control" name="name"
                                placeholder="Nama Akun Anda..." required>
                        </div>
                        <div class="col-12">
